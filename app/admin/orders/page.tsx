      ...
      <TableContainer component={Paper} sx={{ borderRadius: 3, boxShadow: "0 4px 24px rgba(0,0,0,0.06)", border: "1px solid", borderColor: "divider" }}>
        <Table>
          <TableHead sx={{ bgcolor: "grey.50" }}>
            <TableRow>
              <TableCell sx={{ fontWeight: 700, fontSize: "0.75rem", color: "text.secondary", pl: 4 }}>ORDER ID</TableCell>
              <TableCell sx={{ fontWeight: 700, fontSize: "0.75rem", color: "text.secondary" }}>CUSTOMER</TableCell>
              <TableCell sx={{ fontWeight: 700, fontSize: "0.75rem", color: "text.secondary" }}>ITEMS</TableCell>
          ...
          <TableBody>
            {orders.map((order: any) => (
              <TableRow key={order.id} hover>
                ...
                <TableCell>
                  <Typography variant="body2">{order._count.items} Items</Typography>
                </TableCell>
                <TableCell>
                  <Chip
                    label={order.status}
