...
import CushionImage1 from "@/public/home/cushion-pic-01.png"
import CushionImage2 from "@/public/home/cushion-pic-02.png"
import CushionImage3 from "@/public/home/cushion-pic-03.png"
import CushionImage4 from "@/public/home/cushion-pic-04.png"
...
export default function Cushion() {
    ...
    return (
        <>
            <Box component="section" className="serviceCategoryWrapper" id="cushion-1" sx={{ backgroundColor: "#FFE5DB" }}>
                <Container>
                    <Stack direction="column" spacing={8}>
                        <Box className="sectionHeading" sx={{ textAlign: "center" }}>
                            ...
                            <Typography component="h3">
                                Cradle the Sound. Protect the Spirit.
                            </Typography>
                            <Typography variant="body1">
                                A well-balanced cushion supports more than just the bowl — it supports the vibration,
                                and stabilize your bowl and allow the sound to flow freely, undisturbed and fully expressed.
                            </Typography>
                        </Box>
                    </Stack>
                </Container>
                    ...
                    <Stack direction="column" spacing={4} className="serviceCategoryComponent">
                        <Box className="serviceCategorySliderInner">
                            <Swiper
                                ...
                                pagination={false}
                                navigation={{
                                    nextEl: "#cushion-1 .ComSliderNavigation .swiper-button-next",
                                    prevEl: "#cushion-1 .ComSliderNavigation .swiper-button-prev",
                                }}
                                onSwiper={(swiper) => {
                            ...
                            >
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={CushionImage1} alt="singing bowl image" />
                                ...
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={CushionImage2} alt="singing bowl image" />
                                            <IconButton sx={{ backgroundColor: "#F4F4F4" }}>
                                                <Icon name="wishList" width={24} height={24} />
                                            </IconButton>
                                        </Box>
                                ...
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={CushionImage3} alt="singing bowl image" />
                                            <IconButton sx={{ backgroundColor: "#F4F4F4" }}>
                                                <Icon name="wishList" width={24} height={24} />
                                            </IconButton>
                                        </Box>
                                ...
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={CushionImage4} alt="singing bowl image" />
                                            <IconButton sx={{ backgroundColor: "#F4F4F4" }}>
                                                <Icon name="wishList" width={24} height={24} />
                                            </IconButton>
                                        </Box>
