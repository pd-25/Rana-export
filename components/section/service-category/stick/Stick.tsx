...
import StickImage1 from "@/public/home/stick-pic-01.png"
import StickImage2 from "@/public/home/stick-pic-02.png"
import StickImage3 from "@/public/home/stick-pic-03.png"
import StickImage4 from "@/public/home/stick-pic-04.png"
...
export default function Stick() {
    ...
    return (
        <>
            <Box component="section" className="serviceCategoryWrapper" id="stick-1" sx={{ backgroundColor: "#EFCFCE" }}>
                <Container>
                    <Stack direction="column" spacing={8}>
                        <Box className="sectionHeading" sx={{ textAlign: "center" }}>
                            ...
                            <Typography component="h3">
                                Crafted for Precision. Designed for Peace.
                            </Typography>
                            <Typography variant="body1">
                                A well-crafted stick brings out the full resonance of your singing bowl. Made by skilled artisans
                                whether you seek soft ambient vibrations or a strong meditative ring.
                            </Typography>
                        </Box>
                    </Stack>
                </Container>
                    ...
                    <Stack direction="column" spacing={4} className="serviceCategoryComponent">
                        <Box className="serviceCategorySliderInner">
                            <Swiper
                                ...
                                pagination={false}
                                navigation={{
                                    nextEl: "#stick-1 .ComSliderNavigation .swiper-button-next",
                                    prevEl: "#stick-1 .ComSliderNavigation .swiper-button-prev",
                                }}
                                onSwiper={(swiper) => {
                            ...
                            >
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={StickImage1} alt="singing bowl image" />
                                ...
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={StickImage2} alt="singing bowl image" />
                                            <IconButton sx={{ backgroundColor: "#F4F4F4" }}>
                                                <Icon name="wishList" width={24} height={24} />
                                            </IconButton>
                                        </Box>
                                ...
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={StickImage3} alt="singing bowl image" />
                                            <IconButton sx={{ backgroundColor: "#F4F4F4" }}>
                                                <Icon name="wishList" width={24} height={24} />
                                            </IconButton>
                                        </Box>
                                ...
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={StickImage4} alt="singing bowl image" />
                                            <IconButton sx={{ backgroundColor: "#F4F4F4" }}>
                                                <Icon name="wishList" width={24} height={24} />
                                            </IconButton>
                                        </Box>
