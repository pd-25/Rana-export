...
import TingshaImage1 from "@/public/home/tingsha-pic-01.png"
import TingshaImage2 from "@/public/home/tingsha-pic-02.png"
import TingshaImage3 from "@/public/home/tingsha-pic-03.png"
import TingshaImage4 from "@/public/home/tingsha-pic-04.png"


export default function Tingsha() {
    ...
    return (
        <>
            <Box component="section" className="serviceCategoryWrapper" id="tingsha-1" sx={{ backgroundColor: "#FEEBD6" }}>
                <Container>
                    <Stack direction="column" spacing={8}>
                        <Box className="sectionHeading" sx={{ textAlign: "center" }}>
                            ...
                            <Typography variant="body1">
                                Our Tingsha delivers a resonant sound that clears negative energy and grounds your presence.
                                This tool connects sound and sacred space effortlessly.
                            </Typography>
                        </Box>
                    </Stack>
                </Container>
                    ...
                    <Stack direction="column" spacing={4} className="serviceCategoryComponent">
                        <Box className="serviceCategorySliderInner">
                            <Swiper
                                ...
                                pagination={false}
                                navigation={{
                                    nextEl: "#tingsha-1 .ComSliderNavigation .swiper-button-next",
                                    prevEl: "#tingsha-1 .ComSliderNavigation .swiper-button-prev",
                                }}
                                onSwiper={(swiper) => {
                            ...
                            >
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={TingshaImage1} alt="singing bowl image" />
                                ...
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={TingshaImage2} alt="singing bowl image" />
                                            <IconButton sx={{ backgroundColor: "#F4F4F4" }}>
                                                <Icon name="wishList" width={24} height={24} />
                                            </IconButton>
                                        </Box>
                                ...
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={TingshaImage3} alt="singing bowl image" />
                                            <IconButton sx={{ backgroundColor: "#F4F4F4" }}>
                                                <Icon name="wishList" width={24} height={24} />
                                            </IconButton>
                                        </Box>
                                ...
                                <SwiperSlide>
                                    <Box className="serviceCategorySliderItem">
                                        <Box className="imageHolder">
                                            <Image src={TingshaImage4} alt="singing bowl image" />
                                            <IconButton sx={{ backgroundColor: "#F4F4F4" }}>
                                                <Icon name="wishList" width={24} height={24} />
                                            </IconButton>
                                        </Box>
